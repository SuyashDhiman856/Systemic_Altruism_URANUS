  ...
  return (
    <>
      <div className="main-content">
        <h2 className="text-secondary" ref={props.paragraphRef}>Introduction to $URANUS Token</h2>
        <br />
        ...
        <br/>
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/gI7qfHuLQ6Q?si=vCwS1QoZS7-MOZvH" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
        <br />
        <br/>
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/-KJZCYW_pN8?si=ziBzh2S1D3SB5ZlW" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
        <br/>
        <br/>
        <p ref={props.paragraphRef}>
        ...
        ></div>
        <br />
        <h2 className="text-secondary" ref={props.paragraphRef}>Vision and Mission</h2>
        <br />
        <p ref={props.paragraphRef}>
        ...
        <h2 className="text-secondary" ref={props.paragraphRef}>Key Features</h2>
        <br />
        <p ref={props.paragraphRef}>
          ...
          <br />
          <br />
          <strong className="text-secondary" ref={props.paragraphRef}>Security:</strong>
          ...
          <br />
          <br />
          <strong className="text-secondary" ref={props.paragraphRef}>Decentralization:</strong>
          ...
          <br />
          <br />
          <strong className="text-secondary" ref={props.paragraphRef}>Scalability:</strong>
          ...
          <br />
          <br />
          <strong className="text-secondary" ref={props.paragraphRef}>Privacy:</strong>
          ...
          <br />
          <br />
          <strong className="text-secondary" ref={props.paragraphRef}>Community Governance:</strong>
          ...
          <br />
          <br />
          <strong className="text-secondary" ref={props.paragraphRef}>Interoperability:</strong>
        ...
        <br />
        <h2 className="text-secondary">Tokenomics</h2>
        <br />
        <p>
          ...
          <ul>
            <li>
              <strong className="text-secondary text-decoration-underline">Total Supply:</strong> X tokens
            </li>
            <br />
            <li>
              <strong className="text-secondary text-decoration-underline">Initial Distribution:</strong> Initial distribution plan
            </li>
            <br />
            <li>
              <strong className="text-secondary text-decoration-underline">Deflationary Mechanism:</strong> Details of token burning
              or redistribution mechanisms
            </li>
            <br />
            <li>
              <strong  className="text-secondary text-decoration-underline">Token Allocation:</strong> Allocation for liquidity,
              community rewards, development, and marketing
            </li>
          </ul>
        </p>
        <h2 className="text-secondary">Roadmap</h2>
        <br />
        <p>
        ...
        <ul>
          <li>
            <strong className="text-secondary text-decoration-underline">Community Growth:</strong> Expand our community through
            marketing efforts, partnerships, and community engagement
            initiatives.
          </li>
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">Platform Development:</strong> Develop and launch new
            features and products to enhance the $URANUS experience and provide
            additional utility for our token.
          </li>
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">Strategic Partnerships:</strong> Form partnerships with
            other projects, influencers, and organizations to increase
            visibility and adoption of $URANUS Token.
          </li>
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">Ecosystem Expansion:</strong> Explore opportunities to
            expand the $URANUS ecosystem and integrate with other platforms and
            protocols.
          </li>
        </ul>
        <h2 className="text-secondary">How to Buy $URANUS</h2>
        <br />
        <p>
        ...
        <ul>
          <li>
            <strong className="text-secondary text-decoration-underline">Set Up a Wallet:</strong> Before you can buy $URANUS Tokens,
          ...
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">Acquire BNB (Binance Coin):</strong> $URANUS Tokens are
          ...
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">Connect to a Decentralized Exchange (DEX):</strong> $URANUS
          ...
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">Navigate to the $URANUS Token Pair:</strong> Once you've
          ...
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">Set Your Slippage Tolerance:</strong> Slippage refers to the
          ...
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">Enter the Amount:</strong> Specify the amount of BNB you
          ...
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">Confirm the Transaction:</strong> Once you've reviewed and
          ...
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">Wait for Confirmation:</strong> After confirming the
          ...
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">View Your $URANUS Token Balance:</strong> Once the
          ...
          <br />
          <li>
            <strong className="text-secondary text-decoration-underline">Optional:</strong> Add $URANUS Token to Your Wallet: If
        ...
        <h2 className="text-secondary">Safety Disclaimer</h2>
        <br />
        <p>
        ...
        <h2 className="text-secondary">Token Utility</h2>
        <br />
        <p>
        ...
        <br/>
        <h2 className="text-secondary">Elon sues OpenAI, Apple's decline, TikTok ban, Bitcoin $100K?, Science corner: Microplastics</h2>
        <br/>
        <p className="blockquote-footer">BY ALL-IN PODCAST</p>
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/snbTCWL6rxo?si=8nV2Sgb3RZ85XDBi" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
      <div
